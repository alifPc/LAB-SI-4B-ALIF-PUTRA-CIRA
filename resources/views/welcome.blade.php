...
<head prefix="og: http://ogp.me/ns#">
    <title>Alif  | Web Developer &amp; UX Enthusiast</title>
    <meta charset="utf-8">
    ...
    <meta property="og:title" content="Alif 's Personal Website" />
            ...
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand page-scroll" href="http://brittanychiang.com/">
                        <img src="img/logo-transparent-white-30pt.png" />Alif </a>
                </div>
        ...
        <section id="intro" class="intro text-center">
            <div class="overlay">
                <div class="intro-content">
                    <h1 class="animated fadeInDown delay-05s">Hi, I'm Alif</strong>
                    </h1>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 wp1">
                            ...
                            <img src="https://akademik.unsri.ac.id/images/foto_mhs/2021/09031282126104.jpg" id="prof-pic" />
                            <p>
                                Hey! My name is Alif and I'm a web developer with a passion for front end development and design. I'm currently a third year student at
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="modal-description"><strong>Warning:</strong> Very resource heavy &mdash; efficiency &amp; optimization was definitely not a concern for this project.</p>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="visit"><a href="https://us.mullenlowe.com/work/humankinda/" target="_blank" id="visit-btn">Visit Site</a></p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <div class="copyright">
                            ...
                            <p><i class="fa fa-copyright"></i> Alif  2016</p>
                        </div>
                    </div>
                </div>
            </div>
